...
import com.alonso.climaapp.databinding.ActivityMainBinding
import com.alonso.climaapp.repository.ClimaRepository
import com.alonso.climaapp.utils.LocationHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // INICIALIZO EL CLIMA REPOSITORY PARA QUE NO FALLE
    ...
    private fun obtenerClima(ciudad: String) {
        CoroutineScope(Dispatchers.Main).launch {
            try {
                ...
                Log.e("ERROR PERSONALIZADO", errorMessage)
